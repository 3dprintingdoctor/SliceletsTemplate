Windows: put slicer path in the path enviroment
    run by:
        ...
        double click: 1. copy template.bat and template.py to a folder.
...
Mac: put slicer path in the PATH enviroment
    run by:
        command line: slicer --no-main-window --python-script path/to/template.py
        double click: 1. copy template.sh and template.py to a folder.
